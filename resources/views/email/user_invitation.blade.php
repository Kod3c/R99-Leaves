                                                                     ...
                                                                     <tbody>
                                                                        <tr>
                                                                           <td style="width:110px">
                                                                              <img alt="" height="auto" src="https://ci6.googleusercontent.com/proxy/CRcp0Gr1-Ky7K3186yYGhnwInoZee2WUqb_pu-SeXDrsId_wByL6GFqYhTq3HP4smwBgN63SIJBRivlmHLSdqbBvbSE=s0-d-e1-ft#http://localhost/posgo_saas/storage/logo/logo.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%" title="" width="110" class="CToWUd">
                                                                           </td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
