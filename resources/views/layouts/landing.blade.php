            ...
            <div class="row top-bar">
                <div class="col-lg-6 col-md-6 left-part">
                    <ul>
                        <li>
                            <a href="#">                                
                                <img src="{{ asset(Storage::url('uploads/logo/logo.png')) }}" alt="{{ __('Company Logo') }}" width="130px">                                
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="nav-link" href="#testimonials" data-scroll-to="">Testimonials</a>
                        </li>
                    </ul>
                </div>
