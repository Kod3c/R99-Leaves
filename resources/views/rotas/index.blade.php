            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-between justify-content-md-end">
                    <div class="rotas_filter_main_div">                        
                        ...
                        <div class="d-inline-block">
                            <a href="#" class="share_rotas_cls"  title="{{ __('Print rotas') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Share rotas')}}"
                                data-url="{{route('rotas.print_rotas_popup',['loaction'=>$first_location, 'role_id'=>0])}}"></a>                        
                            <a href="#" class="btn btn-sm btn-md btn-white btn-icon-only rounded-circle ml-1" title="{{ __('Share rotas') }}" id="share_rotas"                                
                                data-urls="{{route('rotas.share_popup')}}" >
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','#share_rotas', function () {
            ...
            $(this).parent().find('.share_rotas_cls').attr('data-url', url+'?loaction='+location_id+'&create_by='+created_by+'&role_id='+role_id+'&week='+week+'&user='+user_array);
