            ...
            foreach($count_role_id as $feed_key => $count_role_ids)
            {
                ...
                if(!empty($count_role_ids))
                {
                    ...
                    $feed_calender[$i] = array(
                        ...
                        'html' => '<div>'.$roll_cnt.'<div class=" '.$text_color.' opacity-50 mt-2" style=" font-size: 13px; "> <span title="'.__('Employees').' '.$cnt_employee1.'"><i class="fas fa-user" aria-hidden="true"></i> <span>'.$cnt_employee1.'</span></span> &nbsp;&nbsp;  '.$priceee.'  </div></div>',
                    );
                }
