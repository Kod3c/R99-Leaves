    ...
    public function index(Request $request, Report $report)
    {
        ...
        ********* */
        ...
        foreach ($date_array as $date)
        {
            ...
            $rotas = Rotas::WhereRaw($rotas_where)->whereRaw('publish = 1')
        ...
        ********* */
        ...
        {
            $month_rotas = Rotas::WhereRaw($rotas_where)->whereRaw('publish = 1')
                                ->WhereRaw($manager_location_rota)
                                ->WhereRaw('user_id IN ('.$employee_ids.')')
        ...
        ********* */
        ...
        {
            $user_rotas = Rotas::WhereRaw($rotas_where)->whereRaw('publish = 1')
                                ->WhereRaw($manager_location_rota)
                                ->WhereRaw('user_id IN ('.$employee_ids.')')
        ...
        ********* */
        ...
        {
            $role_rotas = Rotas::WhereRaw($rotas_where)->whereRaw('publish = 1')
                                ->WhereRaw($manager_location_rota)
                                ->WhereRaw('user_id IN ('.$employee_ids.')')
